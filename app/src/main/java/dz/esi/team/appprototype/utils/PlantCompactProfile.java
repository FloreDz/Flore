...
/**
 * Created by azeddine on 31/03/17.
 */
...
public class PlantCompactProfile implements  Section{
    private String id;
        ...
        try {
         ...
         //   SQLiteDatabase db = mDbHelper.getReadableDatabase();
           ...
           // plantProfile = db.query(TABLE_NAME,null,_ID + "=?",selectionArgs,null,null,null);
            ...
            //this.famille = plantProfile.getString(plantProfile.getColumnIndexOrThrow(PlantEntry.famille));
