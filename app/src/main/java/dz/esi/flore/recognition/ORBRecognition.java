package dz.esi.flore.recognition;
...
import dz.esi.flore.ImageOptionsActivity;
import dz.esi.flore.data.PlantContract;
...
public class ORBRecognition {
    ...
    public ArrayList<Couple> Recognize(Bitmap entry) {
        ...
        Cursor cursor = PlantRetriever.RetrievePlants(new String[]{PlantContract.PlantEntry._ID, PlantContract.PlantEntry.sci_name},null,null,null);
        ...
        try {
            while (cursor.moveToNext() && ImageOptionsActivity.threadEnabled ) {
